...
STAEDTE = [
    ...
    Stadt("Olfen", 13175, "https://ratsinfo.olfen.de/bi/si0046.asp", SystemTyp.SESSIONNET, Kreis.COESFELD),
    ...
    Stadt("Ahlen", 52627, "https://www.ahlen.sitzung-online.de/public/", SystemTyp.ALLRIS, Kreis.WARENDORF),
    ...
    Stadt("Ennigerloh", 20000, "https://sessionnet.owl-it.de/ennigerloh/bi/si0046.asp", SystemTyp.SESSIONNET, Kreis.WARENDORF),
    ...
    Stadt("Oelde", 29500, "https://sessionnet.owl-it.de/oelde/bi/si0046.asp", SystemTyp.SESSIONNET, Kreis.WARENDORF),
    ...
    Stadt("Sendenhorst", 14148, "https://sendenhorst.gremien.info/", SystemTyp.GREMIENINFO, Kreis.WARENDORF),
